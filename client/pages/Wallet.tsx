        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Distribuzione delle tue criptovalute
              </CardDescription>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-dark-800 rounded-lg">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">
                      Invia solo {selectedCrypto} a questo indirizzo. Altri
                      token verranno persi.
                    </p>
                  </div>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button
                  variant="outline"
                  className="h-20 border-red-500 text-red-400 hover:bg-red-500 hover:text-white"
                >
                  <div className="flex flex-col items-center gap-2">
              ...
              <DialogContent className="bg-card border-border">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Trasferisci criptovalute dal tuo wallet a un indirizzo
                    esterno
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Disponibile:{" "}
                      {
                        balances.find((b) => b.symbol === selectedCrypto)
                          ?.balance
                      }{" "}
                      {selectedCrypto}
                    </p>
                  ...
                  <div className="p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                    <div className="flex items-center gap-2 text-yellow-400 text-sm">
                      ...
                      <span className="font-medium">
                        Commissioni di rete: 0.0005 {selectedCrypto}
                      </span>
                    </div>
                  </div>
            ...
            <Button
              variant="outline"
              className="h-20 border-gold-500 text-gold-400 hover:bg-gold-500 hover:text-dark-900"
            >
              <div className="flex flex-col items-center gap-2">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="bg-card border-border">
            <CardHeader>
              ...
              <CardDescription>
                Panoramica delle tue criptovalute
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
        ...
        <div className="space-y-6">
          <Card className="bg-card border-border">
            <CardHeader>
              ...
              <CardDescription>
                Collega i tuoi wallet crypto preferiti
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              ...
              <CardDescription>
                Stato della protezione del tuo wallet
              </CardDescription>
            </CardHeader>
